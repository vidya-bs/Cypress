...
it('headers', function() {
    ...
    // headers
        ...
        cy.get(':nth-child(2) > :nth-child(2) > .Table_table-cell-input__fk7qI').type('test',{delay:100});
        cy.wait(1000);

        // value
        cy.get(':nth-child(2) > :nth-child(3) > .Table_table-cell-input__fk7qI').dblclick();
        cy.get(':nth-child(2) > :nth-child(3) > .Table_table-cell-input__fk7qI').type('test');
        cy.wait(1000);
})
...
cy.get('.justify-content-between > .justify-content-start > :nth-child(3)').click();
cy.wait(2000);
...
cy.get('.justify-content-between > .justify-content-start > :nth-child(1)').click();
...
cy.get('.response-tabs > :nth-child(3)').click();
cy.wait(2000);
...
it('push to scm',function() {
    ...
    // Host URL
    cy.get(':nth-child(4) > div.w-100 > .w-100').click();
    cy.get(':nth-child(4) > div.w-100 > .w-100').type('https://github.com/vidya-bs/test.git');
    cy.wait(1000);
...
it('Download collection', function() {
    ...
    cy.get('#637738f8880f666237f634cc').click({ force: true }); 
    cy.xpath('//*[@id="root"]/div/div[2]/div[2]/div[1]/div[2]/div/div[1]/div/div/div/div[3]/div/div/div[2]/div/div/a[4]').click({force: true});
    cy.wait(2000);
})
